...
Returns list iterator object when called without ARG. Returns list iterator
name when called with ARG 'name'.
...
Verifies that input parameters are sufficient. Returns 1 in case of success, 0
otherwise.
