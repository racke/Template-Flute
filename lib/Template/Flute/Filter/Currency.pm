...
Filters prices to be displayed according to the locale and displayed with a
currency symbol.

This filter is based on L<Number::Format>. Any options are passed through to
the L<Number::Format> object.
